    ...
    return (
        <>
           <div className={classes.createAPPage} >
               ...
               <TopBar actor="STUDENT" useCase={`Create ${props.type}`} />
                ...
                <div className={classes.APTo}>
                    ...
                    <RadioGroup className={classes.APToOptions} aria-label="AP-To" name="APTo" value={props.APTo} onChange={handleAPToChange}>
                            ...
                            <FormControlLabel value="Group" control={<Radio />} label="Group" />
                                <Autocomplete
                                    ...
                                    <TextField
                                        ...
                                        variant="filled"
                                        className={props.APTo!=="Group" ? classes.optionSelectorDisabled : ""}
                                        InputProps={{
                                        ...params.InputProps,
                                        endAdornment: (
                                            <React.Fragment>
                            ...
                            <FormControlLabel value="Single Authority" control={<Radio />} label="Single Authority" />
                                <Autocomplete
                                    ...
                                    <TextField
                                        ...
                                        label="Authority"
                                        variant="filled"
                                        className={props.APTo!=="Single Authority" ? classes.optionSelectorDisabled : ""}
                                        InputProps={{
                                        ...params.InputProps,
                                        endAdornment: (
                                            <React.Fragment>
           ...
           <AppBar position="static" color="default">
                ...
                {value === 1 && (
                    <div className={classes.previewMD}>
                        ...
                        <ReactMarkdown plugins={[gfm]} allowDangerousHtml children={props.newAP.content} />
                    </div>
                )}
           </div>
           ...
           <div className={classes.button}>
                <Button variant="contained" className={classes.submitButton} onClick={props.submitFunction}>
                     <SendIcon /> &nbsp; SEND
                </Button>
            </div>
